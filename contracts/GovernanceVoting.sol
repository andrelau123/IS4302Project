...
/// @notice Token-weighted voting contract for protocol-level decisions in the AUTH ecosystem.
/// @dev Voters must stake or hold AUTH tokens; each proposal runs for a fixed period.
contract GovernanceVoting is AccessControl, ReentrancyGuard {
    ...
    /// @notice Cast a vote on a proposal (weighted by AUTH balance).
    ...
    /// @notice Execute proposal results after voting ends.
