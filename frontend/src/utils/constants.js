...
export const CONTRACT_ADDRESSES = {
  ...
  VERIFICATION_MANAGER: process.env.REACT_APP_VERIFICATION_MANAGER_ADDRESS || '0x...', // Replace with actual deployed address
  DISPUTE_RESOLUTION: process.env.REACT_APP_DISPUTE_RESOLUTION_ADDRESS || '0x...', // Replace with actual deployed address
  GOVERNANCE_VOTING: process.env.REACT_APP_GOVERNANCE_VOTING_ADDRESS || '0x...', // Replace with actual deployed address
  ORACLE_INTEGRATION: process.env.REACT_APP_ORACLE_INTEGRATION_ADDRESS || '0x...', // Replace with actual deployed address
};
...
export const ROLES = {
  ...
  DISTRIBUTOR_ROLE: '0x4c6963cf831a14cb00a936eec3e28b9dbc7b5a1e1f0863e8c66aa1e3f0a1c222',
