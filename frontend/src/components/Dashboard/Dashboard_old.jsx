      ...
      <div className="dashboard">
        <div className="container">
          <div className="not-connected">
            <h2>Welcome to FeeDistributor</h2>
      ...
      <div className="container">
        ...
        <div className="stats-grid">
          <div className="stat-card">
            ...
            <div className="stat-value">{pendingRewards} ETH</div>
            <button
          ...
          <div className="stat-card">
            ...
            <div className="stat-value">{totalEarnings} ETH</div>
          </div>

          <div className="stat-card">
            <h3>Auth Token Balance</h3>
            <div className="stat-value">{authTokenBalance} AUTH</div>
          </div>

          <div className="stat-card">
            <h3>Total Distributed</h3>
            <div className="stat-value">{totalDistributed} ETH</div>
          </div>
        </div>
        ...
        <div className="distribution-info">
          <div className="card">
            <h3>Current Distribution Shares</h3>
            <div className="shares-grid">
              <div className="share-item">
                <span className="share-label">Verifiers:</span>
                <span className="share-value">{formatPercentage(distributionShares.verifier)}</span>
              </div>
              <div className="share-item">
                <span className="share-label">Brands:</span>
                <span className="share-value">{formatPercentage(distributionShares.brand)}</span>
              </div>
              <div className="share-item">
                <span className="share-label">Treasury:</span>
                <span className="share-value">{formatPercentage(distributionShares.treasury)}</span>
              </div>
            </div>
          </div>
